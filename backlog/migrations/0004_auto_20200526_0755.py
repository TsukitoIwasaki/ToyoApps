# Generated by Django 2.0.4 on 2020-05-26 07:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('backlog', '0003_remove_issue_modificationtimestamp'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backlog.Invoice')),
            ],
        ),
        migrations.CreateModel(
            name='Item',
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(blank=True, null=True, verbose_name='modificationTimeStamp'),
        ),
        migrations.AddField(
            model_name='invoicedetail',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backlog.Item', verbose_name='商品'),
        ),
    ]
